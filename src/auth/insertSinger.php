...
if (isset($_POST['submit'])) {
    ...
    if (array_filter($errors)) {
        ...
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $updateSinger = "UPDATE singers SET name = '$singername', info = '".mysqli_real_escape_string($conn, $info)."', image = '$images' WHERE id = $id";
            ...
            $insertSinger = "INSERT INTO singers(name, info, image) VALUES ('$singername', '".mysqli_real_escape_string($conn, $info)."', '$images')";
